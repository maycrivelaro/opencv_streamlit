...
import numpy as np
from skimage import morphology, io, color, feature, filters #mais filtros de imagens
...
def escala_cinza(imagem):
	img_cinza = cv2.cvtColor(imagem, cv2.COLOR_BGR2GRAY) #blue, green, red to gray
	return img_cinza
